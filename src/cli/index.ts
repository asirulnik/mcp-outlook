...
program
  ...
  .action(options => testAuthCommand(options));
...
program
  ...
  .requiredOption('-u, --user <email>', 'Email address of the user (required for app-only authentication)')
  .action(options => listFoldersCommand(options));
...
program
  ...
  .requiredOption('-u, --user <email>', 'Email address of the user (required for app-only authentication)')
  .action((folderIdOrPath, options) => listChildFoldersCommand(folderIdOrPath, options));
...
program
  ...
  .action((folderIdOrPath, options) => listEmailsCommand(folderIdOrPath, options));
...
program
  ...
  .action((emailId, options) => readEmailCommand(emailId, options));
...
program
  ...
  .requiredOption('-u, --user <email>', 'Email address of the user')
  .action((emailId, destinationFolderIdOrPath, options) => moveEmailCommand(emailId, destinationFolderIdOrPath, options));
...
program
  ...
  .requiredOption('-u, --user <email>', 'Email address of the user')
  .action((emailId, destinationFolderIdOrPath, options) => copyEmailCommand(emailId, destinationFolderIdOrPath, options));
...
program
  ...
  .action(options => createDraftCommand(options));
...
program
  ...
  .action((name, options) => createFolderCommand(name, options));
...
program
  ...
  .requiredOption('-u, --user <email>', 'Email address of the user')
  .action((folderIdOrPath, newName, options) => renameFolderCommand(folderIdOrPath, newName, options));
...
program
  ...
  .requiredOption('-u, --user <email>', 'Email address of the user')
  .action((folderIdOrPath, destinationParentFolderIdOrPath, options) => moveFolderCommand(folderIdOrPath, destinationParentFolderIdOrPath, options));
...
program
  ...
  .action((options) => listDraftsCommand(options));
...
program
  ...
  .requiredOption('-u, --user <email>', 'Email address of the user')
  .action((draftId, options) => getDraftCommand(draftId, options));
...
program
  ...
  .action((draftId, options) => updateDraftCommand(draftId, options));
...
program
  ...
  .requiredOption('-u, --user <email>', 'Email address of the user')
  .action((draftId, options) => sendDraftCommand(draftId, options));
...
program
  ...
  .requiredOption('-u, --user <email>', 'Email address of the user')
  .action((draftId, options) => deleteDraftCommand(draftId, options));
...
program
  ...
  .requiredOption('-u, --user <email>', 'Email address of the user')
  .action((options) => listCalendarsCommand(options));
...
program
  ...
  .action((options) => listEventsCommand(options));
...
program
  ...
  .requiredOption('-u, --user <email>', 'Email address of the user')
  .option('-c, --calendar-id <id>', 'ID of the specific calendar (defaults to primary)')
  .action((eventId, options) => getEventCommand(eventId, options));
...
program
  ...
  .option('-c, --calendar-id <id>', 'ID of the specific calendar (defaults to primary)')
  .action((options) => createEventCommand(options));
...
program
  ...
  .option('-c, --calendar-id <id>', 'ID of the specific calendar (defaults to primary)')
  .action((eventId, options) => updateEventCommand(eventId, options));
...
program
  ...
  .requiredOption('-u, --user <email>', 'Email address of the user')
  .option('-c, --calendar-id <id>', 'ID of the specific calendar (defaults to primary)')
  .action((eventId, options) => deleteEventCommand(eventId, options));
...
program
  ...
  .action(options => convertHtmlCommand(options));
...
['readme', 'azure', 'quickstart', 'dev', 'troubleshoot', 'modularization'].forEach(doc => {
  program
    ...
    .action(() => {
      ...
      console.log(`Viewing ${filenames[doc as keyof typeof filenames]}...`);
      try {
        const child_process = require('child_process');
        child_process.execSync(`cat ${filenames[doc as keyof typeof filenames]} | less`, { stdio: 'inherit' });
      } catch (error) {

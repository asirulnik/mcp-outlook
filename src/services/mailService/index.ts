import { IAuthService, IFolderService, IEmailService, IDraftService } from '../interfaces';
...
import { NewEmailDraft } from '../../models/draft';
...
export class MailService {
  ...
  private _draftService: IDraftService;
   ...
   */
  constructor(customAuthService?: IAuthService) {
    // Use provided auth service or singleton instance
    this._authService = customAuthService || authService;
    
    // Create the specialized services
    this._folderService = new FolderService(this._authService);
    this._emailService = new EmailService(this._authService, this._folderService);
    this._draftService = new DraftService(this._authService);
  }

  /**
   * Get the folder service
   */
  get folders(): IFolderService {
...
export const mailService = new MailService(authService);

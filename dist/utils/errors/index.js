...
exports.NotFoundError = exports.ValidationError = exports.AuthenticationError = exports.GraphError = void 0;
...
class GraphError extends Error {
    constructor(statusCode, message, graphError) {
        super(message);
...
function handleGraphError(error) {
    ...
    if (error.statusCode && error.body) {
        try {
            ...
            const errorMessage = ((_a = parsedBody.error) === null || _a === void 0 ? void 0 : _a.message) || 'Unknown Graph API error';
...
function formatErrorForUser(error) {
    const { errors } = prompts_1.promptConfig;
 ...
 */
function extractParameterFromErrorMessage(message) {
 ...
 */
function extractValueFromErrorMessage(message) {
